...
func (app *appConnConsensus) FinalizeBlockerSync(req types.RequestFinalizeBlocker) (*types.ResponseFinalizeBlocker, error) {
	//TODO implement me
	return app.appConn.FinalizeBlockerSync(req)
}
